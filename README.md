...
**© 2026 Ayu Asfihani. All rights reserved.** This repository is a portfolio summary shared for recruitment and professional-review purposes only. No part of the content or figures below may be reproduced, redistributed, or reused without written permission from the author. This project was completed individually.

> 🔒 **This is a summary-only repository.** No source code is published here, see [Access the full pipeline](#access-the-full-pipeline) at the bottom.
...
A recurring need in operational tooling, whether tracking warehouse inventory, insurance claims workflows, or internal audit trails, is a system that behaves the same way every time it is tested, and that records exactly what happened for later review. This project builds a small but complete example of that pattern in Java: a seeded, deterministic simulation with structured state management, defensive input handling, and a persistent operation log.
